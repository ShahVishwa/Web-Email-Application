...
function doCustomValidation()
{
  ...
  {
	 console.log("frm 2");
	 document.error_disp_handler.ShowMsg('The Passwords does not match!', frm.password);
...
<input type="password" name="confirm_password" id="confirm_password" value="" class="form-control input-lg" onblur="doCustomValidation()" placeholder="Confirm Password" required /> 
...
<script type="text/javascript">
 ...
 frmvalidator.addValidation("emailAccount","maxlen=50");
