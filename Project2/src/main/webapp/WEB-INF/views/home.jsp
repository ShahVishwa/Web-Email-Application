  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
      ...
      <form class="navbar-form navbar-right" role="logout">
        <div class="form-group">
          <input type="button" class="btn btn-default" onclick="location.href='logout'" value="LogOut">
        </div>
        <!--  <button type="submit" class="btn btn-default" onSubmit=search();>Submit</button>-->
      </form>  
    </div>
  </div>
</nav>
